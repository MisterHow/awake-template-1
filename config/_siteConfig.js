...
export default {
  siteName: 'Alan How',
  tagline: 'A blog of my explorations and discoveries.',
  featureImage: '/uploads/banner-hero.jpg',
  ...
  mainMenu: [
    ...
    {
      name: 'Github Repo',
      link: 'https://github.com/MisterHow',
      target: '_blank'
    }
  ],
  hero: {
  ...
  disqus: {
    ...
    siteShortName: 'blog-alanhow-io' // 'blog-danielkelly-io'
  },
